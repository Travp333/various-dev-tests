...
public class ZombieMove : MonoBehaviour
{
    ...
    void findEscape(){
        ...
        if(dist < criticalDist){
            ...
            //this used to be carrot in the second argument
            if(NavMesh.CalculatePath(transform.position, transform.forward, NavMesh.AllAreas, path)){
                agent.ResetPath();
                agent.SetPath(path);
        ...
        //this used to be carrot in the second argument
        if(NavMesh.CalculatePath(transform.position, transform.forward, NavMesh.AllAreas, path) && !moveBlocked){
    ...
    public void Infect(Collider other)
    {
        ...
        other.gameObject.GetComponent<ZombieMove>().infected = true;
        other.gameObject.GetComponent<ZombieMove>().tex.setAngry();
        flipGate();
