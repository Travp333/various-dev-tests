Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/bac95d9a2ed36924c9c022a89e2786f9"
{
	Properties
	{
 ...
 #define PROP_MOCHIEMETALLICMAPS 
			...
			{
				float smoothness = float(0.432);
				float smoothness2 = float(1);
				float metallic = float(0.192);
				...
				#endif
				reflectionMask *= float(0.214);
				specularMask *= float(0.288);
				if (float(0))
				{
