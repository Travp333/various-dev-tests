Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/57609c65dc4f22b4ea4e190cc96dc740"
{
	Properties
	{
 ...
 #define PROP_MOCHIEMETALLICMAPS 
			...
			{
				float smoothness = float(0.614);
				float smoothness2 = float(1);
				float metallic = float(0.798);
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float3 mainNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN(_BumpMap, _MainTex, poiUV(poiMesh.uv[float(0)], float4(1,1,0,0)), float4(0,0,0,0)), float(0.36));
