Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/2d87c20e5fdee8c48b58d6e31a86f194"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if (float(0))
				{
					mainUV = sharpSample(float4(0.001666667,0.001666667,600,600), mainUV);
				}
