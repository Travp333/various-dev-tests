Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/b43e6481d7e749746a3d04a5fbe05c8f"
{
	Properties
	{
 ...
 #define PROP_EMISSIONMAP 
			...
			{
				float3 emission0 = 0;
				float emissionStrength0 = float(1.97);
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if (float(0))
				{
					mainUV = sharpSample(float4(0.001919386,0.001919386,521,521), mainUV);
				}
