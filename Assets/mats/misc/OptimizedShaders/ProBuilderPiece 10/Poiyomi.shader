Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/f70975a739aaf09408da60e7e47a503b"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_FLAT 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float4 mainTexture = UNITY_SAMPLE_TEX2D(_MainTex, poiUV(mainUV, float4(0.5,0.5,0,0)) + _Time.x * float4(0,0,0,0));
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0,0.006804166,0.2702231,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0,0.006804166,0.2702231,1).a;
