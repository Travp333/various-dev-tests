Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/bf4a5cb8a2199ca44978f6b90df12c0c"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float4 mainTexture = UNITY_SAMPLE_TEX2D(_MainTex, poiUV(mainUV, float4(0.07,0.07,0,0)) + _Time.x * float4(0,0,0,0));
				float3 mainNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN(_BumpMap, _MainTex, poiUV(poiMesh.uv[float(0)], float4(0.07,0.07,0,0)), float4(0,0,0,0)), float(1));
