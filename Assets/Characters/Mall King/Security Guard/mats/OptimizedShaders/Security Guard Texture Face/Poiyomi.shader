Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/4073c8a0415f09345ac70973cfef9fc3"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_TEXTURERAMP 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float4 mainTexture = UNITY_SAMPLE_TEX2D(_MainTex, poiUV(mainUV, float4(1,1,1,1)) + _Time.x * float4(0,0,0,0));
				float3 mainNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN(_BumpMap, _MainTex, poiUV(poiMesh.uv[float(0)], float4(1,1,0,0)), float4(0,0,0,0)), float(3.7));
